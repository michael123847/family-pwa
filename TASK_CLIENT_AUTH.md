...
- Lokaler Heim-Server unter `https://REDACTED-LAN-IP-A:8443` (Caddy + Express)
- Tailscale-Zugang unter `https://<hostname>.REDACTED-TAILNET-A.ts.net:8443` (neu)
...
export const CONFIG = {
  APP_VERSION: 'v21',
  LOCAL_BASE:        'https://REDACTED-LAN-IP-A:8443',  // ← wird ersetzt
...
```js
LAN_BASE: 'https://REDACTED-LAN-IP-A:8443',    // LAN-IP (oder Hostname T14_23)
TS_BASE:  'https://<hostname>.REDACTED-TAILNET-A.ts.net:8443', // Tailscale-Name
```
